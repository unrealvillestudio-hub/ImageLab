// utils/pipeline.ts
import { cropAndConvertToWebP, compositeSubjectsOnBackground } from './image.ts';
import { SubjectAsset } from '../core/types.ts';
import { NO_PACKAGING_NEGATIVE, generateSceneBackground } from '../services/gemini.ts';
