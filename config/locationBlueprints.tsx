...
export const LOCATION_BLUEPRINTS: LocationBlueprint[] = [
  ...
  {
    id: "loc_po_miami_beach_salon",
    brandId: "PatriciaOsorioVizosSalon",
    displayName: "Miami Beach Waterfront (Salón Context)",
  ...
  {
    id: "loc_po_downtown_miami_salon",
    brandId: "PatriciaOsorioVizosSalon",
    displayName: "Downtown Miami (Salón Context)",
  ...
  },
  {
    ...
    reference_photos_path: "Reference_Assets/Patricia_Osorio/",
    imagelab: { realism_level: "cinematic", film_look: "cinematic_soft", lens_preset: "35mm_hero", depth_of_field: "medium", framing: "rule_of_thirds" },
    compatible_archetypes: ["studio_setup","street_interview","single_talking_head"],
    recommended_angles: ["walking_lateral_mar","static_palmeras","golden_hour_silueta","behind_walking_horizonte"]
  },
  {
  ...
  {
    id: "loc_po_comunidad_event",
    brandId: "PatriciaOsorioComunidad",
    displayName: "Evento / Networking Miami",
    locationType: "event_stage",
    city: "Miami", country: "USA", status: "active",
    visual: {
      description: "Espacio de networking Miami. Coworking premium, luz cálida, ambiente de conexión profesional, personas al fondo.",
      materials: ["madera clara","cristal","plantas interior","mobiliario moderno"],
      color_palette: ["blanco","madera","verde plantas","luz cálida"],
      lighting: "luz natural difusa + iluminación cálida interior",
      time_of_day_best: "día",
      signature_elements: ["espacio abierto","gente conversando fondo","mobiliario coworking","luz natural"]
    },
    has_reference_photos: false,
    ...
    compatible_archetypes: ["event_stage","single_talking_head","studio_setup"],
    recommended_angles: ["frontal_charla","lateral_interaccion","wide_sala_networking","close_up_conversacion"]
  },
  {
    id: "loc_dd_cabinas",
